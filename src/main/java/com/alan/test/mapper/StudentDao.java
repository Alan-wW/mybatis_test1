...
public interface StudentDao {
     ...
     * @return 影响行数
     */
    int deleteById(@Param("ids") List<Integer> id);
    ...
    @Select("select * from student stu left join stu_sub ss on stu.id = ss.stu_id where ss.sub_id = #{subId}")
    List<Student> findStudents(int subId);
